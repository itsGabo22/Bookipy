    ...
    >
      ...
      <div className="p-5 flex flex-col flex-grow">
        <div className="flex justify-between items-start mb-4">
          <div>
            <h3 className="text-xl font-bold text-white capitalize">Habitación {room.type.toLowerCase()}</h3>
        ...
        <ul className="text-sm text-gray-300 space-y-2 mb-6 flex-grow">
          <li className="flex items-center gap-2"><Check size={16} className="text-green-400" /> WiFi de Alta Velocidad</li>
          <li className="flex items-center gap-2"><Check size={16} className="text-green-400" /> Servicio a la Habitación</li>
          {room.type === 'SUITE' && <li className="flex items-center gap-2"><Check size={16} className="text-green-400" /> Vista al Mar & Minibar</li>}
        </ul>
